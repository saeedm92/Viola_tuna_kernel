...
int viola_check_reg_access2(char devid, char regoff, char regval)
{
	char regaccess[3]; //, _devid, _regoff, _regval;
	int ret = 0; //, ret2 = -1;
	...
	if (!iomems_initialized) {
		//init_iomem(0x22); //omap5432 led
		init_iomem(0x30); //cam
		init_iomem(0x4b); //galaxy nexus led
		//initialize to zero
		//oregaccess[0] = (char) 0x00;
		//oregaccess[1] = (char) 0x00;
		//oregaccess[2] = (char) 0x00;
	...
	//PRINTK0("[2]: cam_iomem[reg] = %#x, gpio_iomem[reg] = %#x\n",
	//			(unsigned int) cam_iomem[reg],
	//			(unsigned int) gpio_iomem[reg]);
	...
	//	int ii = 0;
	//	for (ii = 0; ii < 10; ii++)
	//		PRINTK0("vib_iomem[%d] = %#x\n", ii, (unsigned int) vib_iomem[ii]);
	//	ii = 0;
	//	for (ii = 8; ii < 13; ii++)
	//		PRINTK0("cam_iomem[%d] = %#x\n", ii, (unsigned int) cam_iomem[ii]);
	//}
	
	if (!ret) {
		if (devid == 0x30) {
			gn_led_iomem[regoff] = (char) regval;
			PRINTK0("[4]\n");
		}
		if (devid == 0x4b) { /* twl6040 */
			twl6040_iomem[regoff] = (char) regval;
			PRINTK0("[5]\n");
		}
		//PRINTK0("[6]: twl6040_iomem[reg] = %#x, gpio_iomem[reg] = %#x\n",
		//		(unsigned int) twl6040_iomem[reg],
...
int main()
{
 char _devid, _regoff, _regval;

 _devid = 0x30; _regoff = 0x2; _regval = 0xc0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x2; _regval = 0xc0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x3; _regval = 0xff;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x4; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x5; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x6; _regval = 0x11;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x7; _regval = 0x11;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x8; _regval = 0x11;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x9; _regval = 0xf3;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0xa; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0xb; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0xc; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0xd; _regval = 0xf3;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0xe; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0xf; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x10; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x11; _regval = 0xf3;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x12; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x13; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x14; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x1; _regval = 0x71;
  viola_check_reg_access2(_devid, _regoff, _regval);

 _devid = 0x4b; _regoff = 0x2d; _regval = 0x11;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x3; _regval = 0x40;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x8; _regval = 0x1;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x8; _regval = 0x1;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x8; _regval = 0x1;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x7; _regval = 0x60;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0xc; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0xd; _regval = 0x18;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0xe; _regval = 0x24;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0xf; _regval = 0x1b;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x10; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x11; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x12; _regval = 0xff;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x13; _regval = 0x1e;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x14; _regval = 0x4;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x15; _regval = 0x1d;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x16; _regval = 0x4;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x17; _regval = 0x1d;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x1f; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0x20; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0xa; _regval = 0x1;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0xc; _regval = 0x1;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x4b; _regoff = 0xc; _regval = 0x5;
  viola_check_reg_access2(_devid, _regoff, _regval);
 ...
 _devid = 0x30; _regoff = 0x2; _regval = 0xc0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x3; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x4; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x5; _regval = 0x0;
 ...
 _devid = 0x30; _regoff = 0x14; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
 _devid = 0x30; _regoff = 0x1; _regval = 0x0;
  viola_check_reg_access2(_devid, _regoff, _regval);
